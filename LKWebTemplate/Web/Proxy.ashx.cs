        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            foreach (var proxy in drsProxy) {
                if (proxy.NEED_REDIRECT == "Y") {
                    ...
                    rem += "\"actions\":{";
                    rem += "\"" + LKWebTemplate.Parameter.Config.ParemterConfigs.GetConfig().DirectApplicationName + "."+proxy.PROXY_ACTION + "\":[";
                    rem += "{";
                    ...
                    rem += "};";
                    rem = LKWebTemplate.Parameter.Config.ParemterConfigs.GetConfig().DirectApplicationName + "." + proxy.PROXY_ACTION + " =" + rem;
                    //rem = " Ext.ns('" + LKWebTemplate.Parameter.Config.ParemterConfigs.GetConfig().DirectApplicationName + "');(function(){" + rem + "})();";
                    rem = "(function(){" + rem + "})();";
                    sb.Append(rem);
                }
            }
